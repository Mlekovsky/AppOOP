...
public class Elektrotechnik extends Naukowiec {
	...
	public Elektrotechnik(String imie, String naziwsko, String osiagniecie, String dyscyplina, List<String> jezyki) 
	{
		super(imie, naziwsko, osiagniecie, dyscyplina, jezyki);
	}
	
	public Elektrotechnik(String imie, String naziwsko, String osiagniecie, String dyscyplina) 
	{
